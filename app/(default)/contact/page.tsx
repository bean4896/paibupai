export const metadata = {
  title: 'Contact - Paibupai Photography',
  description: 'Get in touch with Paibupai Photography in Singapore. Contact us for photography services, event planning, and social media marketing.',
}
...
export default function Contact() {
  return (
    <>
        ...
        <div className="max-w-6xl mx-auto px-4 sm:px-6">
          <div className="max-w-3xl mx-auto text-center">
            ...
            <p className="text-xl text-gray-600 mb-8" data-aos="fade-up" data-aos-delay="100">
              Ready to bring your vision to life? Get in touch with our Singapore photography team today.
            </p>
          </div>
        </div>
      </Section>
              ...
              <form className="space-y-6">
                ...
                <div>
                  ...
                  >
                    ...
                    <option value="photoshooting">Photo Shooting</option>
              ...
              <div className="space-y-8">
                ...
                <div className="flex items-start space-x-4">
                  ...
                  <div>
                    ...
                    <p className="text-gray-600">
                      <a href="tel:+6561234567" className="hover:text-primary-600 transition-colors">
                        +65 6123 4567
                      </a>
                    </p>
                  </div>
                ...
                <div className="flex items-start space-x-4">
                  ...
                  <div>
                    ...
                    <p className="text-gray-600">
                      <a href="mailto:hello@paibupai.com" className="hover:text-primary-600 transition-colors">
                        hello@paibupai.com
                      </a>
                    </p>
                  </div>
      ...
      {/* Map Section */}
      <Section padding="none" className="bg-gray-100">
        <div className="h-96 bg-gray-300 flex items-center justify-center">
          <div className="text-center">
            ...
            <p className="text-sm text-gray-500 mt-2">123 Orchard Road, Singapore 238863</p>
          </div>
        </div>
      </Section>
    </>
