...
import { Section, Heading, Button, CategoryButton, GalleryItem } from './ui'

const categories = [
  { id: '0', name: 'View All', count: '2.7K' },
  { id: '1', name: 'Illustration', count: '1.2K' },
  { id: '2', name: 'Branding', count: '1.4K' },
  { id: '3', name: 'Product Design', count: '1.7K' },
  { id: '4', name: 'Typography', count: '989' }
]

const galleryItems = [
  {
    image: Inspiration01,
    authorName: 'Ada Ahdiyat',
    authorHandle: 'ada-designer-ok',
    ...
    <Section padding="lg">
      ...
      <div>
        ...
        <div className="relative">
          {/* Images grid */}
          <div className="max-w-sm mx-auto sm:max-w-none grid gap-6 sm:grid-cols-2 md:grid-cols-3 items-start" data-aos-id-inspiration>
          ...
          <div className="absolute bottom-0 left-0 right-0 h-[352px] bg-gradient-to-t from-white to-transparent">
            <div className="flex h-full items-end justify-center">
              <Button href="/signup" className="mb-6">
                Join The Community
              </Button>
            </div>
          </div>
