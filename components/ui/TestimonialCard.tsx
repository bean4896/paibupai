...
export default function TestimonialCard({
  ...
  return (
    <div className={`space-y-8 lg:flex items-center lg:space-y-0 lg:space-x-8 text-center lg:text-left ${className}`}>
      <div className="shrink-0 relative inline-flex">
        ...
        <div className="absolute right-0 bottom-0 mr-4 mb-6">
          <a 
            ...
            href="#0"
          >
            <svg className="shrink-0 mr-1.5" width="16" height="13" xmlns="http://www.w3.org/2000/svg">
      ...
      <div className="relative">
        ...
        {buttonText && buttonHref && (
          <div>
            ...
            >
              {buttonText} 
              <span className="tracking-normal text-primary-200 group-hover:translate-x-0.5 transition-transform duration-150 ease-in-out ml-1">
                -&gt;
              </span>
            </Button>
          </div>
